class Display_3 {
    ...
    // static synchronized → requires CLASS LEVEL LOCK (Display_3.class)
    public static synchronized void display_Numbers() {
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            try {
                Thread.sleep(1000); // slow execution to observe locking
            }
    ...
    // also static synchronized → needs SAME CLASS LOCK
